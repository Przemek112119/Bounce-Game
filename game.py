            ...
            if paddle.pausec !=1:
                ...
                if not ball.bottom_hit:
                    ...
                    if highscore < str(ball.hit):
                        ...
                        file1.close()
                    canvas.create_text(250, 250, text="GAME OVER!!\nYour score was: " + str(ball.hit), fill="green", font="Consolas 24 ")
                    root.update_idletasks()
                    root.update()
                    playing = False
                    break
...
canvas.create_text(250, 250, text="Press Enter to start Game!!", fill="green", font="Consolas 18")
root.mainloop()
